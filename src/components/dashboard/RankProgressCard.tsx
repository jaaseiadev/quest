    ...
    <Card variant="prestige">
      ...
      <CardContent>
        ...
        <div className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-3">
          <div className="min-w-0 border border-border bg-surface-container-low p-4">
            <p className="text-label-caps text-muted-foreground">Current XP</p>
            <p className="mt-2 break-words font-display text-xl font-bold text-secondary">
              {stats.totalXp}
            </p>
          </div>
          <div className="min-w-0 border border-border bg-surface-container-low p-4">
            <p className="text-label-caps text-muted-foreground">Next Rank</p>
            <p className="mt-2 break-words font-display text-xl font-bold text-foreground">
