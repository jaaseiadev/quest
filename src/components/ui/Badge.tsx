...
const badgeVariants = cva(
  "clip-chamfer inline-flex max-w-full items-center whitespace-nowrap border px-3 py-2 font-display text-[11px] font-bold uppercase leading-none sm:text-xs",
  {
    variants: {
      variant: {
